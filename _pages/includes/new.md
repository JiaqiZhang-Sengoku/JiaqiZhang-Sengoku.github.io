...
<div class="updates-panel" aria-label="Monthly news">
  <div class="update-card">
    ...
    <ul class="update-list">
      <li><span class="update-day">Jul. 11:</span> We have 2 papers (Image Restoration with Diffusion Models + Cross-Subject IED Detection) accepted to ACM MM 2026 (CCF A). The Image Restoration with Diffusion Models paper is my <span class="highlight-first-author">First Author</span> paper.</li>
    </ul>
  </div>
  <div class="update-card">
