<div class="hero-card" id="about-me">
  <h1 class="hero-title">
    <span class="hero-title__intro">Hi! I am</span>
    <span class="hero-title__name">Jiaqi Zhang</span>
    <span class="hero-title__cn">(Chinese name: 张家旗)</span>
  </h1>
  ...
  <p class="hero-description">My research interests include Bayesian Inverse Problems, Generative Modeling, and Multimodal Affective Computing. Additionally, my recent research focuses on AI Agents, <strong>Multimodal Large Language Model</strong> and World Models.</p>
</div>
